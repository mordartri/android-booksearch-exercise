    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bookAdapter.setOnItemClickListener(new BookAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View itemView, int position) {
                Intent myIntent = new Intent(BookListActivity.this, BookDetailActivity.class);
                myIntent.putExtra("bookTitle", abooks.get(position).getTitle());
                myIntent.putExtra("bookAuthor", abooks.get(position).getAuthor());
                myIntent.putExtra("bookCover", abooks.get(position).getCoverUrl());
